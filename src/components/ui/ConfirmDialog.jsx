      ...
      {open && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="relative bg-white dark:bg-slate-900 rounded-2xl p-6 w-full max-w-sm shadow-2xl border border-gray-100 dark:border-slate-800 z-10"
          >
            ...
            <h3 className="text-[16px] font-bold text-gray-800 dark:text-white text-center mb-2">{title}</h3>
            {message && <p className="text-[13px] text-gray-500 dark:text-slate-400 text-center mb-6 leading-relaxed">{message}</p>}
