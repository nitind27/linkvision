    ...
    >
      <div>
        {breadcrumbs.length > 0 && (
          <nav className="flex items-center gap-1.5 text-[11.5px] text-slate-400 dark:text-slate-500 mb-1.5">
            ...
            {breadcrumbs.map((b, i) => (
              <span key={i} className="flex items-center gap-1.5">
                ...
                {b.to
                  ? <Link to={b.to} className="hover:text-blue-600 dark:hover:text-blue-400 transition font-medium">{b.label}</Link>
